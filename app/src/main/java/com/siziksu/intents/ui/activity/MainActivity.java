...
import com.siziksu.intents.ui.object.adapter.IndexAdapter;

import java.util.ArrayList;
import java.util.List;

public class MainActivity extends ListActivity implements AdapterView.OnItemClickListener, PersonReceiver.NewPersonListener {
  ...
  public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
    ...
    switch (position) {
      ...
      case 8:
        ...
        intent.putExtra("name", "Esteban");
        intent.putExtra("age", "40");
        intent.putExtra("weight", "65");
  ...
  public void onPersonFound(String... params) {
    Toast.makeText(this, "Name: " + params[0] + " Age: " + params[1] + " Weight: " + params[2], Toast.LENGTH_SHORT).show();
  }
